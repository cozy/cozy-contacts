# How to contribute to cozy-contacts?
...
- What is the version of the Cozy cozy-contacts?
...
```
$ git clone github.com/cozy/cozy-contacts.git
$ cd cozy-contacts
$ git remote add fork git://github.com/yourusername/cozy-contacts.git
```
...
Go to https://github.com/yourusername/cozy-contacts and select your branch. Click the 'Pull Request' button and fill out the form.
...
[issues]: https://github.com/cozy/cozy-contacts/issues/new
